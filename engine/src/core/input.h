...
// keyboard input
AGINA_API b8 input_is_key_down(keys key);
AGINA_API b8 input_is_key_up(keys key);
AGINA_API b8 input_was_key_down(keys key);
AGINA_API b8 input_was_key_up(keys key);

void input_process_key(keys key, b8 pressed);

// mouse input
AGINA_API b8 input_is_button_down(buttons button);
AGINA_API b8 input_is_button_up(buttons button);
AGINA_API b8 input_was_button_down(buttons button);
AGINA_API b8 input_was_button_up(buttons button);
AGINA_API void input_get_mouse_position(i32* x, i32* y);
AGINA_API void input_get_previous_mouse_position(i32* x, i32* y);
